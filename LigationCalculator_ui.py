...
class Ui_LigationCalculator(object):
    def setupUi(self, LigationCalculator):
        ...
        LigationCalculator.resize(510, 476)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(42, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem11, 1, 3, 1, 1)
        spacerItem12 = QtWidgets.QSpacerItem(41, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem12, 5, 5, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem13, 1, 5, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem17, 5, 3, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem18, 3, 5, 1, 1)
        ...
        spacerItem19 = QtWidgets.QSpacerItem(42, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem20 = QtWidgets.QSpacerItem(41, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem20, 4, 5, 1, 1)
    ...
    def retranslateUi(self, LigationCalculator):
        ...
        LigationCalculator.setWindowTitle(_translate("LigationCalculator", "连接体系计算器"))
        ...
        self.comboBox_3.setItemText(0, _translate("LigationCalculator", "ng/μg"))
        self.groupBox_3.setTitle(_translate("LigationCalculator", "Vector DNA"))
        self.comboBox_7.setItemText(0, _translate("LigationCalculator", "kb"))
        self.comboBox_4.setItemText(0, _translate("LigationCalculator", "ng/μg"))
        ...
        self.pushButton_5.setText(_translate("LigationCalculator", "计算"))
        self.groupBox.setTitle(_translate("LigationCalculator", "Solutions"))
        self.label_27.setText(_translate("LigationCalculator", "1"))
        self.label_22.setText(_translate("LigationCalculator", "3:1"))
        self.label_32.setText(_translate("LigationCalculator", "1"))
        self.label_24.setText(_translate("LigationCalculator", "1"))
        ...
        self.label_23.setText(_translate("LigationCalculator", "1"))
        self.label_19.setText(_translate("LigationCalculator", "1"))
        self.label_25.setText(_translate("LigationCalculator", "5:1"))
        self.label_14.setText(_translate("LigationCalculator", "1"))
        self.label_16.setText(_translate("LigationCalculator", "1:1"))
        self.label_28.setText(_translate("LigationCalculator", "<html><head/><body><p>1</p></body></html>"))
        self.label_5.setText(_translate("LigationCalculator", "Vector DNA volume(V2)"))
        self.label_29.setText(_translate("LigationCalculator", "<html><head/><body><p>1</p></body></html>"))
        self.label_26.setText(_translate("LigationCalculator", "1"))
        self.label_15.setText(_translate("LigationCalculator", "1"))
        self.label_18.setText(_translate("LigationCalculator", "1"))
        self.label_13.setText(_translate("LigationCalculator", "<html><head/><body><p>1</p></body></html>"))
        self.label_21.setText(_translate("LigationCalculator", "<html><head/><body><p>1</p></body></html>"))
        self.label_8.setText(_translate("LigationCalculator", "Molar scale"))
        self.label_17.setText(_translate("LigationCalculator", "<html><head/><body><p>1</p></body></html>"))
        self.label_6.setText(_translate("LigationCalculator", "Insert DNA volume(V1)"))
        self.label_31.setText(_translate("LigationCalculator", "1"))
        self.label.setText(_translate("LigationCalculator", "Total(ng)"))
        self.label_4.setText(_translate("LigationCalculator", "1"))
        self.label_9.setText(_translate("LigationCalculator", "1"))
        self.label_34.setText(_translate("LigationCalculator", "1"))
        self.label_35.setText(_translate("LigationCalculator", "1"))
        self.label_36.setText(_translate("LigationCalculator", "1"))
